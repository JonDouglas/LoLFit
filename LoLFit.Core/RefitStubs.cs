...
namespace LoLFit.Core
{
    ...
    [Preserve]
    public partial class AutoGeneratedILeagueOfLegendsApi : ILeagueOfLegendsApi
    {
        public HttpClient Client { get; protected set; }
        readonly Dictionary<string, Func<HttpClient, object[], object>> methodImpls;

        public AutoGeneratedILeagueOfLegendsApi(HttpClient client, IRequestBuilder requestBuilder)
        {
